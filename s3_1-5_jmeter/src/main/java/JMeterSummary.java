...
public class JMeterSummary {
    ...
    public JMeterSummary(File inJmeterOutput, int inMillisPerBucket) {
        ...
        System.out.println("JMeterSummary()");
        System.out.println(inJmeterOutput.getAbsoluteFile());
    ...
    public void run() throws IOException {
    	...
    	System.out.println("JMeterSummary().run()");
    ...
    private void add(Matcher inM, Totals inTotal) {
        ...
        if(!inM.group(GROUP_S).equalsIgnoreCase("true")) {
            inTotal.failures ++;
            System.out.println("inTotal.failures : " + inTotal.failures);
        }
